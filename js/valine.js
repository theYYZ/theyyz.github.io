    ...
    , function(e, t, n) {
        ...
        function r(e) {
            ...
            var l = {
                ...
                Weibo: function() {
                    return e.replace(/^.*twitter__([\d.]+).*$/, "$1")
                },
                Douban: function() {
...
*/
    ...
    , function(e, t) {
        function aru(index){
            return "<img class='emoji' src='https://i0.hdslb.com/bfs/emote/" + index + ".png'>";
        }
        function tieba(str){
